...
- Processes: top
- Ports
- Data File: json for input and output, .db file is a data file
- Inspect Running Code: click inspect then you can see the code running, see it using python or jupyter notebooks, tomatoes and breakpoints, 
- Inspect Variables
...
### Computing and Network Diagrams
